import type { TextMeasurer } from '../layout/text.js';

/** Helvetica WinAnsi widths in 1/1000 em. Missing glyphs fall back to 500. */
...
export function helveticaWidth(text: string, fontSize: number): number {
  ...
  for (let i = 0; i < text.length; i++) {
    ...
    w += ((HW[code] ?? 500) * fontSize) / 1000;
  }
  return w;
}

export const helveticaMeasurer: TextMeasurer = {
  widthOf: helveticaWidth,
};
